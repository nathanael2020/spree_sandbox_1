set :application, 	"spree_sandbox_1"
set :repository,  	"git://github.com/nathanael2020/spree_sandbox_1.git"
...
set :default_environment, {
  ...
  "GEM_PATH" => "/usr/local/rbenv/shims/bundle:/usr/local/rbenv/versions/1.9.3-p327/ruby/1.9.1/gems/:/home/nathanael/.gem/ruby:/usr/local/rbenv/shims:/home/nathanael/.rbenv/bin:/usr/local/rbenv/shims:/home/nathanael/.rbenv/bin:/usr/local/rbenv/shims:/usr/local/rbenv/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/home/nathanael/.rbenv/shims:/home/nathanael/.rbenv/bin:$GEM_PATH"
...
namespace :deploy do
  ...
  task :restart, roles: :app, :except => { :no_release => true } do
    run "kill -s USR2 `cat /tmp/unicorn.spree_sandbox_1.pid`"
  end
  ...
  task :stop, roles: :app, :except => { :no_release => true } do
    run "kill -s QUIT `cat /tmp/unicorn.spree_sandbox_1.pid`"
  end 
